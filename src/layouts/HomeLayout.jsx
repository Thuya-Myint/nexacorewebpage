    ...
    return (
        <div className='w-screen h-[20000px] flex flex-col items-center '>
            ...
            <div className='w-full h-[100vh] flex flex-col items-center'>
                <h1 className='mt-[30px] md:mt-[100px] mb-[40px] text-center text-[1.2rem] font-[150]'>
                    {TITLE}
                </h1>
                <Logo where={"hero"} />
                <div className='w-[600px] text-center mt-[40px] mb-[40px]'>
                    <h3 className='px-32 md:px-0 text-[1rem] font-[150] '>
                        {SUBTITLE}
                    </h3>
                </div>
                <button className='transition-all cursor-pointer z-[1000] duration-150 bg-bat-blood mb-[40px] text-white px-2 py-1 rounded-lg flex items-center gap-4 border-2 border-white
          ...
          border-bat-blood flex items-center gap-4 px-2 py-1 transition-all duration-150 rounded-lg'>
            ...
            <div className='w-full relative flex justify-center h-[100vh]'>
                <div className={`w-[350px] md:w-[700px] h-[200px] md:h-[400px]  rounded-xl fixed left-1/2 -translate-x-1/2 transition-all duration-500 ${showBoxOne ? ' top-[30%] md:top-[15%] opacity-100' : 'top-[50%] opacity-0'}`}>
                    <img src={macmock1} alt="" className='w-full h-full ' />
                </div>
                <div className={`absolute transition-all z-[100] bg-Blur w-[95%] md:w-1/2 p-4 text-white  rounded-2xl duration-[1500] text-center ${showBoxOne ? 'top-[90%] opacity-100' : 'top-[50%] opacity-0'}`}
                    style={{
                ...
                <div className={`w-[350px] md:w-[700px] h-[200px] md:h-[400px]  rounded-xl fixed left-1/2 -translate-x-1/2 transition-all duration-500 ${showBoxTwo ? 'top-[30%] md:top-[15%] opacity-100' : 'top-[50%] opacity-0'}`}>
                    <img src={macmock2} alt="" className='w-full h-full ' />
                </div>
                <div className={`absolute transition-all bg-Blur z-[100] w-[95%] md:w-1/2 p-4 text-white  rounded-2xl duration-[1500] text-center ${showBoxTwo ? 'top-[250%] opacity-100' : 'top-[40%] opacity-0'}`}
                    style={{
                        backgroundColor: 'rgba(0,0,0,0.8)'
                    }}>
                ...
                <div className={`w-[350px] md:w-[700px] h-[200px]  md:h-[400px]  rounded-xl fixed left-1/2 -translate-x-1/2 transition-all duration-500 ${showBoxThree ? 'top-[30%] md:top-[15%] opacity-100' : 'top-[50%] opacity-0'}`}>
                    <img src={macmock3} alt="" className='w-full h-full ' />
                </div>
                <div className={`absolute transition-all z-[100] bg-Blur w-[95%] md:w-1/2 p-4 text-white  rounded-2xl duration-[1500] text-center ${showBoxThree ? 'top-[485%] opacity-100' : 'top-[40%] opacity-0'}`}
                    style={{
                        backgroundColor: 'rgba(0,0,0,0.8)'
                    }}>
                ...
                <div className={`w-[350px] md:w-[700px] h-[200px] md:h-[400px] z-50  rounded-xl fixed left-1/2 -translate-x-1/2 transition-all duration-500 ${showBoxFour ? ' top-[30%] md:top-[15%] opacity-100 scale-[1]' : 'top-[50%] opacity-0 scale-[100]'}`}>
                    <img src={macmock1} alt="" className='w-full h-full ' />
                </div>
                <div className={`absolute bg-Blur transition-all z-[100] w-[95%] md:w-1/2 p-4 text-white  rounded-2xl duration-[1500] text-center ${showBoxFour ? 'top-[78%] md:top-[70%] fixed opacity-100' : 'top-[50%] opacity-0'}`}
                    style={{
                        backgroundColor: 'rgba(0,0,0,0.8)'
                    }}>
                ...
                <div className={`w-[700px] h-[400px] z-0   rounded-xl fixed -translate-x-1/2 transition-all duration-500 ${showBoxFive ? 'top-[15%] left-[50%] md:left-[10%] opacity-100' : 'top-[15%] left-[-50%] opacity-0'}`}>
                    <img src={macmock4} alt="" className='w-full h-full ' />
                </div>
                <div className={` bg-Blur absolute transition-all z-[100] w-[100px] p-4 text-white  rounded-2xl duration-[1500] text-center ${showBoxFive ? 'top-[70%] left-[38%] md:left-[6%] fixed opacity-100' : 'top-[50%] opacity-0'}`}
                    style={{
                        backgroundColor: 'rgba(0,0,0,0.8)'
                    }}>
                    <div className='text-[0.9rem] opacity-60'>
                ...
                <div ref={serviceRef}>
                    <div className={`w-full h-[100vh] inset-0 bgSoftwareTeam fixed transition-all duration-700 ${showBoxSeven ? 'opacity-100 ' : 'opacity-0 '}`}>
                        ...
                        >
                            <h1 className={`mt-[15vh] h-fit text-white transition-all duration-700 p-2 w-[95%] md:w-1/2 text-center text-[1.2rem] rounded-lg bg-Blur ${showBoxTwelve ? 'opacity-100 top-0' : 'opacity-0 top-[50%]'
                                }`}
                                style={{
                            ...
                            <p className={`text-white-smoke transition-all duration-700 w-[95%] md:w-1/2 mt-4 p-4 rounded-xl text-center bg-Blur ${showBoxTwelve ? 'opacity-100 top-0' : 'opacity-0 top-[50%]'
                                }`}
                                style={{
                                    backgroundColor: 'rgba(0,0,0,0.4)'
                                }}
                            ...
                            <div className={`transition-all duration-1000 text-white w-[95%] md:w-1/2 mt-4 p-4 rounded-xl text-center bg-Blur relative ${showBoxEight ? 'opacity-100' : 'opacity-0'}`}
                                style={{
                                    backgroundColor: 'rgba(0,0,0,0.4)'
                                }}>
                            ...
                            <div className={`transition-all duration-1000 text-white w-[95%] md:w-1/2 mt-4 p-4 rounded-xl text-center bg-Blur relative ${showBoxNine ? 'opacity-100' : 'opacity-0'}`}
                                style={{
                                    backgroundColor: 'rgba(0,0,0,0.4)'
                                }}>
                            ...
                            <div className={`transition-all duration-1000 text-white w-[95%] md:w-1/2 mt-4 p-4 rounded-xl text-center bg-Blur relative ${showBoxTen ? 'opacity-100' : 'opacity-0'}`}
                                style={{
                                    backgroundColor: 'rgba(0,0,0,0.4)'
                                }}>
                ...
                <div ref={aboutUsRef} className='z-[999]'>
                    <div className={`w-full h-[100vh] inset-0 bg-white fixed transition-all duration-700 ${showBoxThirteen ? 'opacity-100 ' : 'opacity-0 '}`}>
                        <div className={`mt-[12vh] p-4 md:h-[170px] w-full md:w-1/2 transition-all duration-700 bg-black text-white absolute ${showBoxFourteen ? 'opacity-100 left-0' : 'opacity-0 left-[-100%]'}`}>
                        ...
                        <div className={`mt-[15vh] md:mt-[12vh] md:h-[170px] p-4 w-full md:w-1/2 transition-all right-0 duration-700 bg-black text-white absolute ${showBoxFifteen ? showBoxSixteen ? 'opacity-100 right-0 top-0 md:border-l-2 border-white' : 'top-[165px] opacity-100 right-0' : 'opacity-0 right-[-100%] top-[165px]'} }`}>
                    ...
                    <div className={`w-full bg-white h-[75vh] md:h-[50vh] z-[1000] fixed transition-all duration-500 ${showBoxSixteen ? 'opacity-100 left-0 bottom-[0%] mb-[100px]' : 'opacity-0 md:bottom-[-100%] left-[0%]'}`}>
                        <Footer />
                    </div>
                </div>
            </div>
